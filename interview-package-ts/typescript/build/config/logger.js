...
const { colorize, combine, metadata, timestamp, printf } = winston_1.format;
...
const changeLevelToUpperCase = winston_1.format(info => {
    info.level = info.level.toUpperCase();
    return info;
});
const appLogger = winston_1.createLogger({
    level: LOG_LEVEL,
    exitOnError: false,
